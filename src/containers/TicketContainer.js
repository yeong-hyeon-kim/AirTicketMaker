// 컨테이너 컴포넌트
// 리덕스 스토어 상태를 조회하거나, 액션을 디스패치(발생시키는 것)할 수 있는 컴포넌트를 의미합니다.
// 다른 프로젠테이셔널 컴포넌트들을 불러와서 사용합니다.
...
function TicketContainer() {
  ...
  const {
    ...
    // react-redux에 내장되어있는 함수로서, 객체 안의 가장 겉에 있는 값들을 모두 비교해줍니다.
    shallowEqual
  );

  // useDispatch는 리덕스 스토의 dispatch를 함수에서 사용 할 수 있게 해주는 훅(Hook)입니다.
